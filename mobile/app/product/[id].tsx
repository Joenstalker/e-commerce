        ...
        >
          {isAddingToWishlist || isRemovingFromWishlist ? (
            ...
            <Ionicons
              ...
              size={24}
              color={isInWishlist(product._id) ? "#FFFFFF" : "#FFFFFF"}
            />
          )}
        </TouchableOpacity>
      </View>
        ...
        <View className="p-6">
          ...
          <View className="flex-row items-center mb-4">
            ...
            {inStock ? (
              ...
              <View className="ml-3 flex-row items-center">
                <View className="w-2 h-2 bg-accent-red rounded-full mr-2" />
                <Text className="text-accent-red font-semibold text-sm">Out of Stock</Text>
              </View>
            )}
          </View>
          ...
          <View className="mb-6">
            ...
            <View className="flex-row items-center">
              <TouchableOpacity
                className="bg-surface rounded-full w-12 h-12 items-center justify-center border border-surface-lighter"
                onPress={() => setQuantity(Math.max(1, quantity - 1))}
                activeOpacity={0.7}
                disabled={!inStock}
              >
                <Ionicons name="remove" size={24} color={inStock ? "#57534E" : "#78716C"} />
              </TouchableOpacity>
              ...
              >
                <Ionicons
                  name="add"
                  size={24}
                  color={!inStock || quantity >= product.stock ? "#78716C" : "#FFFFFF"}
                />
              </TouchableOpacity>
            </View>
        ...
        <View className="flex-row items-center gap-3">
          ...
          >
            {isAddingToCart ? (
              ...
              <>
                <Ionicons name="cart" size={24} color={!inStock ? "#78716C" : "#FFFFFF"} />
                <Text
