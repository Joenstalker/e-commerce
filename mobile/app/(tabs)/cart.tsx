...
const CartScreen = () => {
  ...
  if (isError) return <ErrorUI onRetry={refetchCart} />;
      ...
      >
        <View className="px-6 gap-2">
          {cartItems.map((item, index) => (
            <View key={item._id} className="bg-surface rounded-3xl overflow-hidden border border-surface-lighter">
              <View className="p-4 flex-row">
                ...
                <View className="flex-1 ml-4 justify-between">
                  ...
                  <View className="flex-row items-center mt-3">
                    <TouchableOpacity
                      className="bg-surface-lighter rounded-full w-9 h-9 items-center justify-center border border-surface-lighter"
                      activeOpacity={0.7}
                    ...
                    >
                      {isUpdating ? (
                        ...
                        <Ionicons name="remove" size={18} color="#57534E" />
                      )}
                    </TouchableOpacity>
...
function ErrorUI({ onRetry }: { onRetry?: () => void }) {
  return (
    <View className="flex-1 bg-background items-center justify-center px-6">
      <Ionicons name="cart-outline" size={64} color="#78716C" />
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <View className="flex-1 items-center justify-center px-6">
        <Ionicons name="cart-outline" size={80} color="#78716C" />
