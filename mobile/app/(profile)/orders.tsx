            ...
            {orders.map((order) => {
              ...
              return (
                <View key={order._id} className="bg-surface rounded-3xl p-5 mb-4">
                  ...
                  <View className="border-t border-surface-lighter pt-3 flex-row justify-between items-center">
                    <View>
...
function ErrorUI({ onRetry }: { onRetry?: () => void }) {
  return (
    <View className="flex-1 items-center justify-center px-6">
      <Ionicons name="receipt-outline" size={64} color="#78716C" />
...
function EmptyUI() {
  return (
    <View className="flex-1 items-center justify-center px-6">
      <Ionicons name="receipt-outline" size={80} color="#78716C" />
