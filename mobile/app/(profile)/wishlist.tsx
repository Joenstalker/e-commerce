...
function WishlistScreen() {
  ...
  if (isError) return <ErrorUI onRetry={refetchWishlist} />;
    ...
    <SafeScreen>
      ...
      {wishlist.length === 0 ? (
        <View className="flex-1 items-center justify-center px-6">
          <Ionicons name="heart-outline" size={80} color="#78716C" />
        ...
        >
          <View className="px-6 py-4">
            {wishlist.map((item) => (
              <TouchableOpacity
                key={item._id}
                className="bg-surface rounded-3xl overflow-hidden mb-3 border border-surface-lighter"
                activeOpacity={0.8}
              ...
              >
                <View className="flex-row p-4">
                  <Image
                    ...
                    className="rounded-2xl bg-surface-lighter"
                  ...
                  <View className="flex-1 ml-4">
                    ...
                    {item.stock > 0 ? (
                      ...
                      <View className="flex-row items-center">
                        ...
                        <Text className="text-accent-red text-sm font-semibold">Out of Stock</Text>
                      </View>
                    )}
                  </View>
...
function ErrorUI({ onRetry }: { onRetry?: () => void }) {
  return (
    <SafeScreen>
      ...
      <View className="flex-1 items-center justify-center px-6">
        <Ionicons name="heart-outline" size={64} color="#78716C" />
