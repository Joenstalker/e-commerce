              ...
              <ScrollView className="mb-4">
                {order?.orderItems.map((item, index) => {
                  ...
                  return (
                    <View
                      key={item._id}
                      className={`bg-surface-lighter rounded-2xl p-4 border border-surface-lighter ${
              ...
              <View className="gap-3">
                ...
                >
                  {isSubmitting ? (
                    ...
                    <Text className="text-white font-bold text-base">Submit All Ratings</Text>
                  )}
                </TouchableOpacity>
                <TouchableOpacity
                  className="bg-surface-lighter rounded-2xl py-4 items-center border border-surface-lighter"
                  activeOpacity={0.7}
                  onPress={onClose}
                  disabled={isSubmitting}
                >
